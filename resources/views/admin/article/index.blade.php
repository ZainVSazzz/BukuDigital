<x-dashboard-layout page-title="News">
    ...
    <div class="card w-full p-6 bg-base-100 shadow-xl mt-2">
        <div class="text-xl font-semibold inline-block">
            ...
            <form class="inline-block float-right">
                ...
                <a href="{{ route('admin.article.create') }}" class="btn btn-secondary btn-sm">Add Article</a>
            </form>
        </div>
            ...
            <div class="overflow-x-auto w-full">
                <table class="table w-full">
                    ...
                    @foreach($articles->items() as $article)
                        <tr>
                            <td>
                                <div class="font-bold text-wrap">{{ $article->title }}</div>
                            </td>
                            ...
                            <td>
                                <div class="flex gap-x-1 items-center">
                                    <div class="tooltip tooltip-top" data-tip="Edit">
                                        <a href="{{ route('admin.article.edit', $article->slug) }}" class="btn btn-sm btn-info">
                                    ...
                                    <div class="tooltip tooltip-top" data-tip="Delete">
                                        <button class="btn btn-sm btn-warning" onclick="confirmDelete('{{ $article->title }}', '{{ $article->slug }}')">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
    ...
    @push('scripts')
        <script>
            ...
            function confirmDelete(title, slug) {
                deleteForm.setAttribute('action', '{{ route('admin.article') }}/' + slug)
