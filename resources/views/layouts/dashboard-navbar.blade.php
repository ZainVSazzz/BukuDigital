<div class="navbar sticky top-0 bg-[#f8f9fa] dark:bg-base-200 z-10 shadow-md" x-data="{currentTheme: localStorage.getItem('theme')}">
    <div class="flex-1">
    ...
    <div class="flex-none ">
        <label class="swap ">
            <input type="checkbox"/>
            <svg data-set-theme="emerald" data-act-class="ACTIVECLASS" class="fill-current w-6 h-6" :class="currentTheme === 'dark' ? 'swap-on' : 'swap-off'" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 3v2.25m6.364.386-1.591 1.591M21 12h-2.25m-.386 6.364-1.591-1.591M12 18.75V21m-4.773-4.227-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0Z" />
            </svg>
            <svg data-set-theme="dark" data-act-class="ACTIVECLASS" class="fill-current w-6 h-6" :class="currentTheme === 'emerald' ? 'swap-on' : 'swap-off'" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <div class="dropdown dropdown-end mx-4">
            <label tabindex="0" class="flex items-center flex-nowrap cursor-pointer w-full avatar">
                ...
                <span class="font-light ml-2 mr-1">Hi, {{ Auth::user()->name }}</span>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-3 h-3">
                    <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                </svg>
            </label>
            <ul tabindex="0" class="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                <span class="block px-4 my-2 text-xs font-bold">{{ Auth::user()->is_admin ? 'ADMIN' : 'PEMBACA' }}</span>
